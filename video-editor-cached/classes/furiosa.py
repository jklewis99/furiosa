...
from PyQt5.QtCore import (pyqtSlot, QCommandLineOption, QCommandLineParser, QDir, 
                            QFileInfo, QProcess, QProcessEnvironment, 
                            QSettings, QSize, QStandardPaths, QTimerEvent, Qt)
from PyQt5.QtGui import (QCloseEvent, QContextMenuEvent, QDragEnterEvent, QDropEvent, 
...
from project_panel import ConsoleWidget #, VideoLogger
